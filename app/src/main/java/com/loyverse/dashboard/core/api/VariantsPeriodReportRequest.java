...
public class VariantsPeriodReportRequest {
    ...
    public VariantsPeriodReportRequest(int ownerId, Integer merchantId, int limit, int offset, long startDate, long endDate, String sortBy, String sortType, String cookieHash, long timestamp, long tzOffset, long[] outletsIds) {
